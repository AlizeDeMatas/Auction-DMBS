...
insert into sellerAccount values(0900,4163430091,'Steve','1627893','ScotiaBank','ssstevejk@gmail.com',8);
insert into sellerAccount values(0933,4378920934,'Nana','839831','RBC','nanananana@gmail.com',7);
insert into sellerAccount values(1278,9872636480,'Xavier','Xforce99','CIBC','XxxMmmmAaaa@gmail.com',9);
insert into sellerAccount values(1283,4163546435,'Sarah','c3qv3g5','BMO','sarah@gmail.com',8);
insert into sellerAccount values(1289,4253252264,'Anna','f43f3g34','TD','annanna@gmail.com',8);
...
CREATE TABLE item(
    ...
    Nname VARCHAR2(20) DEFAULT 'NOT PROVIDED',
    Categories VARCHAR2(15) DEFAULT 'NOT PROVIDED',
    Condition VARCHAR2(100) DEFAULT 'NOT PROVIDED',
    Appraiser VARCHAR2(20) DEFAULT 'NOT PROVIDED',
    Owners VARCHAR2(20) DEFAULT 'NOT PROVIDED',
...
insert into item values('xe2f2f43',13200,'Diamond Ring','Jewelry', 'Real','Tony','King','Turkey',87900);
insert into item values('d2c24f4g',12300,'Sweet Potato','Grocery', 'Real','Zhong','King','China',67000);
insert into item values('n6nej42',10000,'Red Garnet','Gem', 'Pure','Tedd','King','Asgard',23100);
insert into item values('f43vqh1',350,'Kobo','E-product', 'Second-hand','Eva','Unknown','Canada',450);
insert into item values('f2h21542',50000,'Acura Integra','Vehicle', 'New','Dan','Someone','Brazil',50000);
